...
class CircleAdmin(admin.ModelAdmin):
    ...
    make_verified.short_description = 'Make selected circles verifided'
    def make_unverified(self,request,queryset):
        """Make circles unverified"""
        queryset.update(verified=False)
    
    make_unverified.short_description = 'Make selected circles unverifided'
    ...
    download_todays_rides.short_description='Download_todays_rides'